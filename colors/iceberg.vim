...
" Modified:   2020-04-16 18:03+0900
" License:    MIT
...
if &background == 'light'
  hi! ColorColumn cterm=NONE ctermbg=253 guibg=#dcdfe7
  hi! CursorColumn cterm=NONE ctermbg=253 guibg=#dcdfe7
  hi! CursorLine cterm=NONE ctermbg=253 guibg=#dcdfe7
  ...
  hi! PmenuSbar ctermbg=251 guibg=#cad0de
  hi! PmenuSel ctermbg=248 ctermfg=235 guibg=#a7b2cd guifg=#33374c
  hi! PmenuThumb ctermbg=237 guibg=#33374c
  ...
  hi! SpellBad ctermbg=181 ctermfg=237 gui=undercurl guisp=#cc517a
  hi! SpellCap ctermbg=117 ctermfg=237 gui=undercurl guisp=#2d539e
  hi! SpellLocal ctermbg=116 ctermfg=237 gui=undercurl guisp=#3f83a6
  hi! SpellRare ctermbg=110 ctermfg=237 gui=undercurl guisp=#7759b4
  ...
  hi! Visual ctermbg=251 guibg=#c9cdd7
