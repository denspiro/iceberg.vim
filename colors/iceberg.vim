...
" Modified:   2020-03-13 08:37+0900
" License:    MIT
...
if &background == 'light'
  hi! ColorColumn cterm=NONE ctermbg=235 guibg=#dcdfe7
  hi! CursorColumn cterm=NONE ctermbg=235 guibg=#dcdfe7
  hi! CursorLine cterm=NONE ctermbg=235 guibg=#dcdfe7
  ...
  hi! PmenuSbar ctermbg=236 guibg=#cad0de
  ...
  hi! SpellBad ctermbg=95 ctermfg=252 gui=undercurl guisp=#cc517a
  hi! SpellCap ctermbg=24 ctermfg=252 gui=undercurl guisp=#2d539e
  hi! SpellLocal ctermbg=23 ctermfg=252 gui=undercurl guisp=#3f83a6
  hi! SpellRare ctermbg=97 ctermfg=252 gui=undercurl guisp=#7759b4
  ...
  hi! Visual ctermbg=236 guibg=#c9cdd7
